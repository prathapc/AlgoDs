...
public class F_BucketSort {
   ...
   * the index of the bucket, meaning that we have the index number of papers that have
   * reference greater than or equal to the index. Which will be our h-index result.
   * The reason to scan from the end of the array is that we are looking for the greatest h-index.
   * For example, given array [3,0,6,5,1], we have 6 buckets to contain how many papers have
