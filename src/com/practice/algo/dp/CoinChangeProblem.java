...
public class CoinChangeProblem {
	...
	public static void main(String[] args) {
		...
		System.out.println(dynamicProgrammingMinNumberOfCoinsRequired(coins, totalCoins, sum));
	}

	private static int dynamicProgrammingMinNumberOfCoinsRequired(int[] coins, int totalCoins, int sum) {
